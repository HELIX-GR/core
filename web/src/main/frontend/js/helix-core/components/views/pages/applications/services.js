          ...
          <div className="page__wrapper">
            ...
            <div className="page__content">
              <ul className="page__breadcrumbs">
                ...
                <li><a href="#">{_t({ id: 'breadcrumb.services' })}</a></li>
              </ul>
              <WordPressPage className="page__content__default" name={'applications-services'} />
            </div>
          </div>
        </div>
      </main >
...
export default injectIntl(ReactRedux.connect(mapStateToProps, mapDispatchToProps, mergeProps)(Services));
