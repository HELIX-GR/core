            ...
            <div className="page__wrapper">
              <div className="page__sidebar">
                ...
                <ul className="page__sidebar__menu">
                  ...
                  <li>
                    <NavLink to={StaticRoutes.FirstPhaseClimpact} activeClassName="active">
...
export default injectIntl(ReactRedux.connect(mapStateToProps, mapDispatchToProps, mergeProps)(Committee));
