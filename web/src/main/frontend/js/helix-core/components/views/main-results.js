        ...
        <section className="main-results-page-content">
          <div className="results-main-content">
            ...
            <section className="results-main-sidebar">
              ...
              {this.renderParameters(EnumFacet.Organization, 'ORGANIZATIONS', 'name', 'title', 'org', MIN_FACET_VALUES, showAllOrganizations)}

              {this.renderParameters(EnumFacet.Group, 'TOPICS', 'name', 'title', 'grp', MIN_FACET_VALUES, showAllGroups)}

              {this.renderParameters(EnumFacet.Tag, 'TAGS', 'name', 'display_name', 'tag', MIN_FACET_VALUES, showAllTags)}

              {this.renderParameters(EnumFacet.Format, 'FORMATS', null, null, 'fmt', MIN_FACET_VALUES, showAllFormats)}

              {this.renderParameters(EnumFacet.License, 'LICENSES', 'id', 'title', 'lic', MIN_FACET_VALUES, showAllLicenses)}
