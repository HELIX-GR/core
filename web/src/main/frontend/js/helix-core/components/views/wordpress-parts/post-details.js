...
class NewsDetails extends React.Component {
  ...
  get loadRelated() {
    ...
    return (category === EnumPostCategory.News);
  }
...
export default injectIntl(ReactRedux.connect(mapStateToProps, mapDispatchToProps, mergeProps)(NewsDetails));
