...
class Targets extends React.Component {
  ...
  render() {
    return (
      <AboutTemplate page={page} breadcrumb={'breadcrumb.targets'} />
    );
  }
...
export default injectIntl(ReactRedux.connect(mapStateToProps, mapDispatchToProps, mergeProps)(Targets));
