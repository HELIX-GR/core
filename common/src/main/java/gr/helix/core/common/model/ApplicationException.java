...
public class ApplicationException extends RuntimeException {
    ...
    /**
     * Return an instance of an {@link Error} (of same error code) by formatting the
    ...
    public Error toError(MessageSource messageSource, Locale locale) {
        return new Error(this.code, this.withFormattedMessage(messageSource, locale).getMessage());
    }
